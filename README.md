...
From the logarithmic plot it can be infered that both radixSort and radixSortPar are logarithmically proportional to quickSort and each other. Roughly, the runtime of quickSort is proportinal to radixSort with constant 6, and to radixSortPar with constant 11.
